...
public class CVSModelDB {
	...
	private CVSModelDB() {
		...
		projectList.add(new CVSProject("'보신각역'", new Staff(25, "최해림", "haerimchoi19@gmail.com", "오후"),
						new Consumer(300, "남60%, 여40%", "30~40대", "담배, 복권, 숙취음료"),
						new CVSType("보신각점", "20억", "담배", "취객 난동 주의")));
		
		projectList.add(new CVSProject("'해운대역'", new Staff(3, "김아라", "funfun36@gmail.com", "새벽"),
